        ...
        <div className="space-y-4">
          ...
          {inputMode === 'bulk' ? (
            <Card className="space-y-3">
              <div>
                <h2 className="text-[16px] font-bold text-[var(--text-primary)] mb-1">비교하고 싶은 AI 결과물이나 의견들을 붙여넣으세요</h2>
                <p className="text-[12px] text-[var(--text-secondary)]">여러 결과물을 한 번에 붙여넣으면 AI가 자동으로 소스를 분리합니다.</p>
              </div>
              <textarea
                value={bulkInput}
