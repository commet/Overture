      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="mt-12 flex items-center justify-center gap-4">
          <Link
            ...
            className="inline-flex items-center gap-2.5 px-7 py-3.5 bg-[var(--primary)] text-white rounded-full text-[15px] font-bold hover:opacity-90 transition-all duration-300 shadow-lg"
          >
            서곡 시작하기
        ...
        <p className="mt-16 text-[12px] text-[#a0a4b8] tracking-wide">
          Overture — 오픈소스 프로젝트
        </p>
      </div>
    </section>
