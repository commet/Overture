...
Check if `.overture/journal.md` exists in the project root. If it does, read it. If you see patterns from previous `/reframe` runs (e.g., "user often has capacity assumptions"), mention it briefly before starting.
