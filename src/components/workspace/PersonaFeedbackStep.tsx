...
[말투 원칙 — 가장 중요]
- 보고서 톤 금지. 이 사람이 실제 회의실에서 하는 말투로 쓰세요.
- 나쁜 예: "실행 가능성에 대한 우려가 있습니다" / "긍정적이나 보완이 필요합니다"
- 좋은 예: "이거 2주 안에 된다고? 재무팀 데이터 받는 데만 일주일이야" / "방향은 좋은데, 내가 이 대표한테 전화해서 뭐라고 말하냐가 빠져있어"
- 1인칭으로. 구체적 상황과 행동을 언급하세요. 일반론 금지.
- 이 사람의 성격에 따라: 까칠하면 까칠하게, 신중하면 신중하게, 직설적이면 직설적으로.
...
{
  "overall_reaction": "이 사람이 자료를 처음 봤을 때의 즉각 반응. 한 문장, 구어체로. 예: '방향은 좋은데 숫자가 빠져있잖아'",
  "failure_scenario": "이 계획이 실패하는 구체적 시나리오. 이 사람이 직접 겪을 상황으로. 예: '재무팀에서 데이터 안 주면 2주 다 날아가'",
  "untested_assumptions": ["이 자료가 당연히 참이라고 깔고 있는 가정 1~3개. 이 사람 관점에서"],
  "classified_risks": [
