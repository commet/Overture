...
{
  "overall_reaction": "이 사람이 자료를 처음 봤을 때의 즉각 반응. 한 문장, 자연스러운 말투로. 예: '방향은 좋은데 숫자가 빠져있는 것 같아요'",
  "failure_scenario": "이 계획이 실패하는 구체적 시나리오. 이 사람이 직접 겪을 상황으로. 예: '재무팀에서 데이터 안 넘겨주면 2주 일정이 통째로 밀려요'",
