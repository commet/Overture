  ...
  return (
    <section className="max-w-5xl mx-auto px-6 pt-16 md:pt-24 pb-10 md:pb-14">
      ...
      <div className="text-center max-w-2xl mx-auto">
        ...
        <p className="mt-5 text-[16px] md:text-[18px] text-[var(--text-secondary)] leading-relaxed max-w-xl mx-auto">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 md:p-6">
          ...
          <p className="text-[15px] font-bold text-[var(--text-primary)] mb-2 leading-snug">
            &ldquo;경쟁사 대응 전략을 세워줘&rdquo;
          </p>
          <p className="text-[13px] text-[var(--text-secondary)] leading-relaxed">
            경쟁사 분석 보고서가 나오지만, 우리가 싸울 판이 어디인지 정의하지 않았기 때문에 방향이 엉뚱합니다.
          </p>
        </div>
        ...
        <div className="rounded-2xl border-2 border-[var(--accent)] bg-[var(--surface)] p-5 md:p-6 relative">
          ...
          <div className="flex items-center gap-1.5 text-[11px] font-bold text-amber-700 uppercase tracking-wider mb-2 mt-1">
            <AlertTriangle size={12} />
            숨겨진 전제
          </div>
          <p className="text-[13px] text-[var(--text-primary)] font-medium mb-3 pl-3 border-l-2 border-amber-400 leading-relaxed">
            &ldquo;경쟁사와 같은 시장에서 싸워야 한다&rdquo;
            <span className="text-amber-700 block mt-0.5 text-[12px]">&rarr; 우리 강점은 경쟁사가 없는 틈새에 있을 수 있음</span>
          </p>

          <div className="flex items-center gap-1.5 text-[11px] font-bold text-[var(--accent)] uppercase tracking-wider mb-2">
            <Sparkles size={12} />
            재정의된 질문
          </div>
