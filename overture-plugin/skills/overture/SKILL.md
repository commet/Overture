...
Check if `.overture/journal.md` exists. If it does, read it. Look for patterns from previous runs — recurring weak areas, repeated assumption types, strategies that worked. Mention any relevant patterns to the user before starting.
