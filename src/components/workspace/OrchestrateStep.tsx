...
[actor 배정 원칙 — 작업의 성격이 최우선 기준]
- "ai": 정보 수집, 데이터 분석, 초안 생성, 패턴 탐색, 번역/요약 등 정답이 있거나 양이 많은 작업
- "human": 전략 방향 결정, 이해관계자 설득/협상, 윤리·정치적 판단, 최종 승인, 관계 기반 작업
- "both": AI가 선택지·근거를 제시하고 사람이 최종 판단하는 작업. 분석은 AI, 해석은 사람.
- 판단 기준: "이 작업의 결과가 틀렸을 때 누가 책임지는가?" → 사람이면 "human" 또는 "both"
