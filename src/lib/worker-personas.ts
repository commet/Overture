...
const COMPLETION_NOTES: Record<string, string[]> = {
  ...
  finance: ['재무 모델 정리했습니다.', '시나리오별 숫자 뽑았어요.', '가정이 무너지는 지점 표시해뒀습니다.'],
  marketing: ['포지셔닝 정리했어요.', '타겟·메시지 연결해봤습니다.', '채널별 퍼널 그려봤어요.'],
  people_culture: ['조직 관점에서 정리했습니다.', '사람 문제부터 짚어봤어요.', '구조와 실행 같이 제안드립니다.'],
  // 체인 에이전트 (신규)
