...
const SYNTHESIZE_SCENARIOS = [
  {
    emoji: '\u{1F916}',
    label: 'AI \uB3C4\uAD6C\uBCC4 \uB2F5\uBCC0 \uBE44\uAD50',
    template: 'ChatGPT \uB2F5\uBCC0:\n\uB3D9\uB0A8\uC544 \uC2DC\uC7A5 \uADDC\uBAA8\uB294 \uC57D 500\uC5B5 \uC6D0\uC73C\uB85C \uCD94\uC815\uB418\uBA70, \uD2B9\uD788 \uBCA0\uD2B8\uB0A8\uACFC \uC778\uB3C4\uB124\uC2DC\uC544\uAC00 \uC8FC\uC694 \uC2DC\uC7A5\uC785\uB2C8\uB2E4.\n\nClaude \uB2F5\uBCC0:\n\uD574\uB2F9 \uC2DC\uC7A5\uC740 300~700\uC5B5 \uC6D0 \uC0AC\uC774\uB85C \uCD94\uC815\uD558\uBA70, \uD0DC\uAD6D\uACFC \uD544\uB9AC\uD540\uC758 \uC131\uC7A5\uB960\uC774 \uB354 \uB192\uC544 \uC6B0\uC120 \uAC80\uD1A0\uAC00 \uD544\uC694\uD569\uB2C8\uB2E4.',
  },
  {
    emoji: '\u{1F465}',
    label: '\uD300\uC6D0\uBCC4 \uC758\uACAC \uC815\uB9AC',
    template: '\uB9C8\uCF00\uD305\uD300 \uC758\uACAC:\n\uC18C\uC15C \uBBF8\uB514\uC5B4 \uC911\uC2EC \uCE60\uD398\uC778\uC774 \uD6A8\uACFC\uC801. \uC778\uD50C\uB8E8\uC5B8\uC11C \uB9C8\uCF00\uD305 \uC608\uC0B0 \uD655\uB300 \uD544\uC694.\n\n\uC601\uC5C5\uD300 \uC758\uACAC:\n\uAE30\uC874 B2B \uCC44\uB110 \uAC15\uD654\uAC00 \uC6B0\uC120. \uC18C\uC15C\uC740 ROI\uAC00 \uBD88\uD655\uC2E4.',
  },
  {
    emoji: '\u{1F4D1}',
    label: '\uB9AC\uC11C\uCE58 \uC790\uB8CC \uC885\uD569',
    template: 'McKinsey \uB9AC\uD3EC\uD2B8:\nAI \uB3C4\uC785 \uAE30\uC5C5\uC758 60%\uAC00 \uBE44\uC6A9 \uC808\uAC10 \uD6A8\uACFC\uB97C \uBCF4\uACE0. \uD3C9\uADE0 ROI 12%.\n\nGartner \uBD84\uC11D:\nAI \uD504\uB85C\uC81D\uD2B8\uC758 85%\uAC00 \uAE30\uB300 \uC774\uD558\uC758 \uC131\uACFC. \uC8FC\uC694 \uC6D0\uC778\uC740 \uB370\uC774\uD130 \uD488\uC9C8\uACFC \uC870\uC9C1 \uBB38\uD654.',
  },
];
        ...
        <div className="space-y-4">
          ...
          {inputMode === 'bulk' ? (
            <Card className="space-y-3">
              <div>
                <h2 className="text-[16px] font-bold text-[var(--text-primary)] mb-1">어떤 결과물을 합성할까요?</h2>
                <p className="text-[12px] text-[var(--text-secondary)]">시나리오를 선택하거나 직접 붙여넣으세요.</p>
              </div>
              <ScenarioCards
                title="빠르게 시작하기"
                scenarios={SYNTHESIZE_SCENARIOS}
                onSelect={(t) => setBulkInput(t)}
              />
              <textarea
                value={bulkInput}
                onChange={(e) => setBulkInput(e.target.value)}
                placeholder={"ChatGPT 답변:\n시장 규모는 약 500억 원으로 추정되며...\n\nClaude 답변:\n해당 시장은 300~700억 원 사이로 추정하며, 특히..."}
          ...
          <div className="flex justify-end">
            <Button onClick={handleAnalyze} disabled={inputMode === 'bulk' ? !bulkInput.trim() : individualSources.filter((s) => s.content.trim()).length < 2}>
